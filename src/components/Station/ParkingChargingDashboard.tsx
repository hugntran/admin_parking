...
const ParkingChargingDashboard = () => {
  ...
  const parkingLocations = locations.filter((loc) => loc.services.includes("PARKING") && !loc.services.includes("CHARGING"));
  const chargingLocations = locations.filter((loc) => loc.services.includes("CHARGING") && !loc.services.includes("PARKING"));
  const combinedLocations = locations.filter((loc) => loc.services.includes("PARKING") && loc.services.includes("CHARGING"));
